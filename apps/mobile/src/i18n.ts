...
const pt: Dictionary = {
  ...
  "profile.exportBody": "Cria uma cópia, em formato JSON, dos dados guardados neste dispositivo: favoritos, recentes, alimentos personalizados, a refeição atual, as refeições guardadas e o diário.",
  ...
  "profile.deleteBody": "Remove permanentemente, deste dispositivo, os favoritos, recentes, alimentos personalizados, a refeição atual, as refeições guardadas e o diário. Esta ação não pode ser desfeita.",
...
const en: Dictionary = {
  ...
  "profile.exportBody": "Creates a JSON copy of the data stored on this device: favourites, recents, custom foods, the current meal, saved meals, and the Diário (meal history).",
  ...
  "profile.deleteBody": "Permanently removes, from this device, your favourites, recents, custom foods, the current meal, saved meals, and the Diário (meal history). This cannot be undone.",
