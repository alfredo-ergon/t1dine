...
const pt: Dictionary = {
  ...
  "glucose.connectPromptBody": "Ligue o seu site Nightscout acima para ver leituras reais, ou ative \"Ver exemplo\" para experimentar com dados de demonstração.",
  ...
  "glucose.connect.intro": "Ligue o seu site Nightscout (apenas leitura) para ver aqui as suas leituras de glicose reais. Não é preciso conta T1Dine. O token fica guardado apenas neste dispositivo — nunca é guardado nos servidores do T1Dine.",
...
const en: Dictionary = {
  ...
  "glucose.connectPromptBody": "Connect your Nightscout site above to see real readings, or turn on \"See example\" to try it with demo data.",
  ...
  "glucose.connect.intro": "Connect your Nightscout site (read-only) to see your real glucose readings here. No T1Dine account needed. Your token is stored only on this device — it is never stored on T1Dine's servers.",
