...
const pt: Dictionary = {
  ...
  "profile.deleteBody": "Remove permanentemente, deste dispositivo, os favoritos, recentes, alimentos personalizados, a refeição atual, as refeições guardadas, o diário e as receitas. Esta ação não pode ser desfeita.",
...
const en: Dictionary = {
  ...
  "profile.deleteBody": "Permanently removes, from this device, your favourites, recents, custom foods, the current meal, saved meals, the Diário (meal history), and recipes. This cannot be undone.",
